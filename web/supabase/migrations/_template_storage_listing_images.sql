-- Bucket listing-images + RLS политики
-- Этот файл создаётся скриптом из RUN под правильным номером миграции.
...
-- Загрузка: только аутентифицированные, путь должен начинаться с их uid
