...
export const AREAS: Record<string, string[]> = {
  ...
  'Кишинёв':   ['Центр', 'Ботаника', 'Рышкановка', 'Буюканы', 'Чеканы', 'Телецентр', 'Дурлешты', 'Трушень', 'Весь город'],
  'Кагул':     ['Центр', 'Весь город'],
  'Унгень':    ['Центр', 'Весь город'],
  'Сороки':    ['Центр', 'Весь город'],
  'Орхей':     ['Центр', 'Весь город'],
  'Хынчешты':  ['Центр', 'Весь город'],
  'Яловень':   ['Центр', 'Весь город'],
  'Страшень':  ['Центр', 'Весь город'],
  'Флорешты':  ['Центр', 'Весь город'],
  'Дрокия':    ['Центр', 'Весь город'],
  'Эдинец':    ['Центр', 'Весь город'],
  'Рышканы':   ['Центр', 'Весь город'],
  'Теленешты': ['Центр', 'Весь город'],
  'Криулень':  ['Центр', 'Весь город'],
  'Чимишлия':  ['Центр', 'Весь город'],
  'Новые Анены': ['Центр', 'Весь город'],
  'Калараш':   ['Центр', 'Весь город'],
  'Леова':     ['Центр', 'Весь город'],
  'Тараклия':  ['Центр', 'Весь город'],
};
